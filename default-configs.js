...
TERMINAL COMMANDS:
- When the user enters a terminal command (like 'ls', 'cd', 'git', etc.), it will be executed directly
- Normal conversation and questions will be processed by the AI assistant
