 ...
 */
export function createSessionFile(now, toolRow, toolStatusMd, agentName) {
 ...
 */
export function logUserPrompt(sessionFile, prompt) {
 ...
 */
export function logToolUsed(sessionFile, toolName) {
 ...
 */
export function logAgentResponse(sessionFile, response) {
 ...
 */
export function logAgentError(sessionFile, errMsg) {
